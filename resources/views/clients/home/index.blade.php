...
<div id="app">
    ...
    <div class="default-height ph-item">
        <div class="slider-main owl-carousel">
            <div class="bg-image one">
                <img src="./assets/clients/images/brand-logos/FahasaT4_Bo1_Slide_840x320_3.jpeg" alt="">
            </div>
            <div class="bg-image two">
                
                    <img src="./assets/clients/images/brand-logos/McBooksT4_Slide_840x320.jpeg" alt="">
               
            </div>
            <div class="bg-image three">
                
                    <img src="./assets/clients/images/brand-logos/Platinum_minhlong_ide_840x320.jpeg" alt="">
        ...
        <div class="container">
            <div class="image-banner">
                <a href="shop-v1-root-category.html" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="/assets/clients/images/banners/bannerlayer-1.jpg" alt="Winter Season Banner">
                </a>
            </div>
        </div>
    </div>
    ...
    <section class="section-maker">
        <div class="container">
            <div class="sec-maker-header text-center">
                <h3 class="sec-maker-h3">Sản phẩm mới</h3>
                                    ...
                                    <div class="item">
                                        <div class="image-container">
                                            <a class="item-img-wrapper-link" href="single-product.html">
                                                <img class="img-fluid" src="/assets/clients/images/product/product@3x.jpg" alt="Product">
                                            </a>
    ...
    <section class="section-maker">
        <div class="container">
            <div class="sec-maker-header text-center">
                <span class="sec-maker-span-text">Sản phẩm mới</span>
                <h3 class="sec-maker-h3 u-s-m-b-22">Khuyến mại</h3>
    ...
    <div class="banner-image-view-more">
        <div class="container">
            <div class="image-banner u-s-m-y-40">
                <a href="shop-v1-root-category.html" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="/assets/clients/images/banners/ban-men.jpg" alt="Banner Image">
                </a>
            </div>
    ...
    <div class="brand-slider u-s-p-b-80">
        <div class="container">
            <div class="brand-slider-content owl-carousel" data-item="5">
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 1">
                    </a>
                </div>
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 2">
                    </a>
                </div>
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 3">
                    </a>
                </div>
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 5">
                    </a>
                </div>
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 6">
                    </a>
                </div>
                <div class="brand-pic">
                    <a href="#">
                        <img src="/assets/clients/images/brand-logos/b1.png" alt="Brand Logo 7">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                            <div class="newsletter-image">
                                <a href="shop-v1-root-category.html" class="banner-hover effect-dark-opacity">
                                    <img class="img-fluid" src="/assets/clients/images/banners/newsletter-1.jpg" alt="Newsletter Image">
                                </a>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <!-- Product-zoom-area -->
                            <div class="zoom-area">
                                <img id="zoom-pro-quick-view" class="img-fluid" src="/assets/clients/images/product/product@4x.jpg" data-zoom-image="/assets/clients/images/product/product@4x.jpg" alt="Zoom Image">
                                <div id="gallery-quick-view" class="u-s-m-t-10">
                                    <a class="active" data-image="/assets/clients/images/product/product@4x.jpg" data-zoom-image="/assets/clients/images/product/product@4x.jpg">
                                        <img src="/assets/clients/images/product/product@2x.jpg" alt="Product">
                                    </a>
                                    <a data-image="/assets/clients/images/product/product@4x.jpg" data-zoom-image="/assets/clients/images/product/product@4x.jpg">
                                        <img src="/assets/clients/images/product/product@2x.jpg" alt="Product">
                                    </a>
                                    <a data-image="/assets/clients/images/product/product@4x.jpg" data-zoom-image="/assets/clients/images/product/product@4x.jpg">
                                        <img src="/assets/clients/images/product/product@2x.jpg" alt="Product">
