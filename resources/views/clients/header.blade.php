            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="home.html">
                            <img src="/assets/clients/images/main-logo/fahasa-logo.png" style="width: 100%" alt="Groover Brand Logo" class="app-brand-logo">
                        </a>
                    </div>
                </div>
            ...
            <ul class="mini-cart-list">
                <li class="clearfix">
                    <a href="single-product.html">
                        <img src="/assets/clients/images/product/product@1x.jpg" alt="Product">
            ...
            <div class="row align-items-center">
                                        ...
                                        <div class="v-drop-right" style="width: 700px;">
                                            ...
                                            <div class="v-image" style="bottom: 0;right: -25px">
                                                <a href="#" class="d-block">
                                                    <img src="/assets/clients/images/banners/mega-3.png" class="img-fluid" alt="Product">
                                                </a>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="col-lg-9">
                    <ul class="bottom-nav g-nav u-d-none-lg">
                        <li>
                            <a href="{{route('productall')}}">Sản phẩm
